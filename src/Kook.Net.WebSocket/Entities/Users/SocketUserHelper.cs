...
{
    public static async Task<IReadOnlyCollection<SocketVoiceChannel>> GetConnectedChannelsAsync(IGuildUser user, BaseSocketClient client, RequestOptions options)
    {
