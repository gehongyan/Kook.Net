...
public interface IMentionable
{
    ...
    /// </summary>
    /// <returns>
    ///     A string that is recognized by KaiHeiLa as a mention in plain text formatted text.
    /// </returns>
    ...
    /// </summary>
    /// <returns>
    ///     A string that is recognized by KaiHeiLa as a mention in KMarkdown formatted text.
    /// </returns>
