...
public class SocketReaction : IReaction
{
    ...
    ///     <see cref="KaiHeiLa.WebSocket.SocketReaction.User" /> cannot be retrieved.
    /// </remarks>
    /// <returns>
    ...
    ///         <see cref="KaiHeiLa.WebSocket.SocketReaction.UserId" />.
    ///     </para>
    ///     <para>
    ///         If you wish to obtain an identifiable user object, consider utilizing
    ///         <see cref="KaiHeiLa.Rest.KaiHeiLaRestClient" /> which will attempt to retrieve the user from REST.
    ///     </para>
    /// </remarks>
    /// <returns>
