...
namespace KaiHeiLa.WebSocket
{
    ...
    public interface ISocketMessageChannel : IMessageChannel
    {
        ...
        ///         request to KaiHeiLa. This read-only collection may include messages that have been deleted. The
        ///         maximum number of messages that can be retrieved from this method depends on the
        ///         <see cref="KaiHeiLa.WebSocket.KaiHeiLaSocketConfig.MessageCacheSize" /> set.
        ///     </para>
        /// </remarks>
        ...
        ///     A read-only collection of WebSocket-based messages.
        /// </returns>
        IReadOnlyCollection<SocketMessage> GetCachedMessages(int limit = KaiHeiLaConfig.MaxMessagesPerBatch);
        ...
        ///     A read-only collection of WebSocket-based messages.
        /// </returns>
        IReadOnlyCollection<SocketMessage> GetCachedMessages(Guid fromMessageId, Direction dir, int limit = KaiHeiLaConfig.MaxMessagesPerBatch);
        /// <summary>
        ///     Gets the last N cached messages starting from a certain message in this message channel.
        /// </summary>
        /// <remarks>
        ...
        ///     A read-only collection of WebSocket-based messages.
        /// </returns>
        IReadOnlyCollection<SocketMessage> GetCachedMessages(IMessage fromMessage, Direction dir, int limit = KaiHeiLaConfig.MaxMessagesPerBatch);
    }
}
