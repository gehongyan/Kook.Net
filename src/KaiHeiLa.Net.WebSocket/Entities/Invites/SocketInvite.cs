...
public class SocketInvite : SocketEntity<uint>, IInvite
{
    ...
    internal SocketInvite(KaiHeiLaSocketClient kaiHeiLa, SocketGuild guild, SocketGuildChannel channel, SocketGuildUser inviter, uint id)
        : base(kaiHeiLa, id)
    {
        Guild = guild;
        Channel = channel;
    ...
    internal static SocketInvite Create(KaiHeiLaSocketClient kaiHeiLa, SocketGuild guild, SocketGuildChannel channel, SocketGuildUser inviter, Model model)
    {
        var entity = new SocketInvite(kaiHeiLa, guild, channel, inviter, model.Id);
        entity.Update(model);
        return entity;
    }
