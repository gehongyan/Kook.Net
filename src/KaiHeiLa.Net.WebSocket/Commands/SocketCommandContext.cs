...
namespace KaiHeiLa.Commands
{
    ...
    public class SocketCommandContext : ICommandContext
    {
        ...
        /// <summary>
        ///     Gets the <see cref="KaiHeiLaSocketClient" /> that the command is executed with.
        /// </summary>
        public KaiHeiLaSocketClient Client { get; }
        ...
        public SocketCommandContext(KaiHeiLaSocketClient client, SocketUserMessage msg)
        {
            Client = client;
        ...
        /// <inheritdoc/>
        IKaiHeiLaClient ICommandContext.Client => Client;
