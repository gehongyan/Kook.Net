...
// Pages Models
[JsonSerializable(typeof(Kook.API.Rest.PagedResponseBase<Kook.API.Channel>))]
[JsonSerializable(typeof(Kook.API.Rest.PagedResponseBase<Kook.API.Emoji>))]
[JsonSerializable(typeof(Kook.API.Rest.PagedResponseBase<Kook.API.ExtendedThreadPost>))]
[JsonSerializable(typeof(Kook.API.Rest.PagedResponseBase<Kook.API.Game>))]
[JsonSerializable(typeof(Kook.API.Rest.PagedResponseBase<Kook.API.Guild>))]
[JsonSerializable(typeof(Kook.API.Rest.PagedResponseBase<Kook.API.Invite>))]
[JsonSerializable(typeof(Kook.API.Rest.PagedResponseBase<Kook.API.MessageTemplate>))]
[JsonSerializable(typeof(Kook.API.Rest.PagedResponseBase<Kook.API.Role>))]
[JsonSerializable(typeof(Kook.API.Rest.PagedResponseBase<Kook.API.UserChat>))]
[JsonSerializable(typeof(Kook.API.Rest.PagedResponseBase<Kook.API.Rest.BoostSubscription>))]
[JsonSerializable(typeof(Kook.API.Rest.PagedResponseBase<Kook.API.Rest.GuildMember>))]
// Misc Models
