...
/// <summary>
///     提供用于注册与配置 <see cref="T:Kook.Webhook.AspNet.KookAspNetWebhookClient"/> 的扩展方法。
/// </summary>
public static class KookWebhookClientExtension
{
    ...
    /// </summary>
    /// <param name="services"> 要向其添加 KOOK ASP.NET Webhook 客户端的 <see cref="IServiceCollection" />。 </param>
    /// <param name="config"> 用于配置 KOOK ASP.NET Webhook 客户端的 <see cref="KookAspNetWebhookConfig" />。 </param>
    /// <returns> 添加了 KOOK ASP.NET Webhook 客户端的 <see cref="IServiceCollection" />。 </returns>
    ...
    /// </summary>
    /// <param name="builder"> 要向其添加 KOOK Webhook 端点的 <see cref="T:Microsoft.AspNetCore.Builder.IApplicationBuilder" /> 应用程序构建器。 </param>
    /// <param name="routePattern"> 用于注册 KOOK Webhook 的路由模式。 </param>
    /// <returns> 添加了 KOOK Webhook 端点的 <see cref="T:Microsoft.AspNetCore.Builder.IApplicationBuilder" /> 应用程序构建器。 </returns>
