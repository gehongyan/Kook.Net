...
public class RequireUserPermissionAttribute : PreconditionAttribute
{
    ...
    /// <summary>
    ///     Requires that the user invoking the command to have a specific <see cref="Kook.GuildPermission"/>.
    /// </summary>
    /// <remarks>
    ///     This precondition will always fail if the command is being invoked in a <see cref="IPrivateChannel"/>.
    /// </remarks>
    /// <param name="permission">
    ///     The <see cref="Kook.GuildPermission" /> that the user must have. Multiple permissions can be
    ...
    /// </summary>
    /// <param name="permission">
    ///     The <see cref="Kook.ChannelPermission"/> that the user must have. Multiple permissions can be
    ///     specified by ORing the permissions together.
    /// </param>
