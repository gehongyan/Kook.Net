...
{
    /// <summary>
    ///     Provides a framework for building KaiHeiLa commands.
    /// </summary>
    /// <remarks>
    ///     <para>
    ///         The service provides a framework for building KaiHeiLa commands both dynamically via runtime builders or
    ...
    ///         <see cref="KaiHeiLa.Commands.CommandService.Log" /> for any command-related log events, and
    ///         <see cref="KaiHeiLa.Commands.CommandService.CommandExecuted" /> for information about commands that have
