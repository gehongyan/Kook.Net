...
namespace KaiHeiLa.Commands
{
    ...
    {
        /// <summary>
        ///     Gets the specified <see cref="KaiHeiLa.GuildPermission" /> of the precondition.
        /// </summary>
        public GuildPermission? GuildPermission { get; }
        /// <summary>
        ///     Gets the specified <see cref="KaiHeiLa.ChannelPermission" /> of the precondition.
        /// </summary>
        ...
        /// <summary>
        ///     Requires that the user invoking the command to have a specific <see cref="KaiHeiLa.GuildPermission"/>.
        /// </summary>
        /// <remarks>
        ///     This precondition will always fail if the command is being invoked in a <see cref="IPrivateChannel"/>.
        /// </remarks>
        /// <param name="permission">
        ///     The <see cref="KaiHeiLa.GuildPermission" /> that the user must have. Multiple permissions can be
        ...
        /// <summary>
        ///     Requires that the user invoking the command to have a specific <see cref="KaiHeiLa.ChannelPermission"/>.
        /// </summary>
        /// <param name="permission">
        ///     The <see cref="KaiHeiLa.ChannelPermission"/> that the user must have. Multiple permissions can be
        ///     specified by ORing the permissions together.
        /// </param>
