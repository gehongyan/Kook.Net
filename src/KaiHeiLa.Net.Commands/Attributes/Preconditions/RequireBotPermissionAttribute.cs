...
namespace KaiHeiLa.Commands
{
    ...
    public class RequireBotPermissionAttribute : PreconditionAttribute
    {
        ...
        /// <summary>
        ///     Requires the bot account to have a specific <see cref="KaiHeiLa.GuildPermission"/>.
        /// </summary>
        /// <remarks>
        ///     This precondition will always fail if the command is being invoked in a <see cref="IPrivateChannel"/>.
        /// </remarks>
        /// <param name="permission">
        ///     The <see cref="KaiHeiLa.GuildPermission"/> that the bot must have. Multiple permissions can be specified
        ...
        /// <summary>
        ///     Requires that the bot account to have a specific <see cref="KaiHeiLa.ChannelPermission"/>.
        /// </summary>
        /// <param name="permission">
        ///     The <see cref="KaiHeiLa.ChannelPermission"/> that the bot must have. Multiple permissions can be
