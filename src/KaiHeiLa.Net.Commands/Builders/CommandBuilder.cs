...
namespace KaiHeiLa.Commands.Builders
{
    public class CommandBuilder
    {
        ...
        internal CommandBuilder(ModuleBuilder module, string primaryAlias, Func<ICommandContext, object[], IServiceProvider, CommandInfo, Task> callback)
            : this(module)
        {
            KaiHeiLa.Preconditions.NotNull(primaryAlias, nameof(primaryAlias));
            KaiHeiLa.Preconditions.NotNull(callback, nameof(callback));
