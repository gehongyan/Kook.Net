...
public class SocketTextChannel : SocketGuildChannel, ITextChannel, ISocketMessageChannel
{
    ...
    /// <inheritdoc />
    /// <remarks>
    ///     This property is only available if the <see cref="KookGatewayConfig.MessageCacheSize"/> is set to a value greater than zero.
    /// </remarks>
    /// <seealso cref="KookGatewayConfig.MessageCacheSize"/>
    ...
    internal SocketTextChannel(KookGatewayClient kook, ulong id, SocketGuild guild)
        : base(kook, id, guild)
    {
