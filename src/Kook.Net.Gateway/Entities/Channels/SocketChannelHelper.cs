...
{
    public static IAsyncEnumerable<IReadOnlyCollection<IMessage>> GetMessagesAsync(ISocketMessageChannel channel, KookGatewayClient kook,
    ...
    public static IReadOnlyCollection<SocketMessage> GetCachedMessages(ISocketMessageChannel channel, KookGatewayClient kook, MessageCache messages,
    ...
    public static void AddMessage(ISocketMessageChannel channel, KookGatewayClient kook,
        SocketMessage msg)
    {
        switch (channel)
        {
    ...
    /// <exception cref="NotSupportedException">Unexpected <see cref="ISocketMessageChannel"/> type.</exception>
    public static SocketMessage RemoveMessage(ISocketMessageChannel channel, KookGatewayClient kook,
        Guid id) =>
        channel switch
        {
    ...
    public static async Task<IReadOnlyCollection<SocketGuildUser>> GetConnectedUsersAsync(SocketVoiceChannel channel,
        SocketGuild guild, KookGatewayClient kook, RequestOptions options)
    {
