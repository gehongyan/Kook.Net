...
public class SocketDMChannel : SocketChannel, IDMChannel, ISocketPrivateChannel, ISocketMessageChannel
{
    ...
    internal SocketDMChannel(KookGatewayClient kook, Guid chatCode, SocketUser recipient)
    ...
    internal static SocketDMChannel Create(KookGatewayClient kook, ClientState state, Guid chatCode, User recipient)
    {
