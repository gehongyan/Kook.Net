...
public class SocketVoiceChannel : SocketGuildChannel, IVoiceChannel, ISocketAudioChannel
{
    ...
    ///         To ensure accuracy, you may need to enable <see cref="KookGatewayConfig.AlwaysDownloadVoiceStates"/>
    ...
    internal SocketVoiceChannel(KookGatewayClient kook, ulong id, SocketGuild guild)
        : base(kook, id, guild) =>
