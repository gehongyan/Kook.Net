...
public class SocketInvite : SocketEntity<uint>, IInvite
{
    ...
    internal SocketInvite(KookGatewayClient kook, SocketGuild guild, SocketGuildChannel channel, SocketGuildUser inviter, uint id)
        : base(kook, id)
    {
        Guild = guild;
        Channel = channel;
    ...
    internal static SocketInvite Create(KookGatewayClient kook, SocketGuild guild, SocketGuildChannel channel, SocketGuildUser inviter, Model model)
    {
