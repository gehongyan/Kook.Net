...
public class SocketGuildUser : SocketUser, IGuildUser, IUpdateable
{
    ...
    ///             or <see cref="KookGatewayClient.DownloadBoostSubscriptionsAsync"/>
    ///             upon a <see cref="KookGatewayClient"/> to manually download the latest boost subscription data,
    ...
    ///         or <see cref="KookGatewayClient.DownloadVoiceStatesAsync"/> is called.
