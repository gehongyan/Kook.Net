...
public class SocketSelfUser : SocketUser, ISelfUser
{
    ...
    internal SocketSelfUser(KookGatewayClient kook, SocketGlobalUser globalUser)
        : base(kook, globalUser.Id) =>
        GlobalUser = globalUser;

    internal static SocketSelfUser Create(KookGatewayClient kook, ClientState state, Model model)
    {
