...
public abstract class SocketMessage : SocketEntity<Guid>, IMessage, IUpdateable
{
    ...
    internal SocketMessage(KookGatewayClient kook, Guid id, ISocketMessageChannel channel, SocketUser author, MessageSource source)
        : base(kook, id)
    {
        Channel = channel;
        Author = author;
    ...
    internal static SocketMessage Create(KookGatewayClient kook, ClientState state, SocketUser author, ISocketMessageChannel channel,
