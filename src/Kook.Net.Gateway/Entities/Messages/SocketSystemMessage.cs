...
public class SocketSystemMessage : SocketMessage, ISystemMessage
{
    ...
    internal SocketSystemMessage(KookGatewayClient kook, Guid id, ISocketMessageChannel channel, SocketUser author)
        : base(kook, id, channel, author, MessageSource.System)
    {
    }

    internal static new SocketSystemMessage Create(KookGatewayClient kook, ClientState state, SocketUser author, ISocketMessageChannel channel,
