...
public class SocketUserMessage : SocketMessage, IUserMessage
{
    ...
    internal SocketUserMessage(KookGatewayClient kook, Guid id, ISocketMessageChannel channel, SocketUser author, MessageSource source)
        : base(kook, id, channel, author, source)
    {
    }

    internal static new SocketUserMessage Create(KookGatewayClient kook, ClientState state, SocketUser author, ISocketMessageChannel channel,
