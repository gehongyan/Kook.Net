...
internal static class KookRestApiClientExperimentalExtensions
{
    ...
    public static async Task<RichGuild> CreateGuildAsync(this KookRestApiClient client,
        CreateGuildParams args, RequestOptions? options = null)
    {
        ...
        KookRestApiClient.BucketIds ids = new();
        return await client.SendJsonAsync<RichGuild>(HttpMethod.Post,
                () => "guild/create", args, ids, ClientBucketType.SendEdit, false, options)
            .ConfigureAwait(false);
    }

    public static async Task DeleteGuildAsync(this KookRestApiClient client,
        DeleteGuildParams args, RequestOptions? options = null)
    {
        Preconditions.NotNull(args, nameof(args));
        ...
        await client.SendJsonAsync(HttpMethod.Post,
                () => $"guild/delete", args, ids, ClientBucketType.SendEdit, options)
            .ConfigureAwait(false);
    }

    public static async Task<RichGuild> ModifyGuildAsync(this KookRestApiClient client,
        ulong guildId, ModifyGuildParams args, RequestOptions? options = null)
    {
        ...
        return await client.SendJsonAsync<RichGuild>(HttpMethod.Post,
                () => $"guild/update", args, ids, ClientBucketType.SendEdit, false, options)
            .ConfigureAwait(false);
    }

    public static async Task SyncChannelPermissionsAsync(this KookRestApiClient client,
        SyncChannelPermissionsParams args, RequestOptions? options = null)
    {
        Preconditions.NotNull(args, nameof(args));
        ...
        await client.SendJsonAsync(HttpMethod.Post,
                () => $"channel-role/sync", args, ids, ClientBucketType.SendEdit, options)
            .ConfigureAwait(false);
    }
        ...
        int limit = KookConfig.MaxUsersPerBatch, int fromPage = 1, RequestOptions? options = null)
    {
        ...
        return client.SendPagedAsync<VoiceRegion>(HttpMethod.Get,
            (pageSize, page) => $"guild/regions&page_size={pageSize}&page={page}",
    ...
    public static async Task DisconnectUserAsync(this KookRestApiClient client,
        DisconnectUserParams args, RequestOptions? options = null)
    {
        Preconditions.NotNull(args, nameof(args));
        Preconditions.NotEqual(args.ChannelId, 0, nameof(args.ChannelId));
        ...
        KookRestApiClient.BucketIds ids = new(channelId: args.ChannelId);
        await client.SendJsonAsync(HttpMethod.Post,
                () => $"channel/kickout", args, ids, ClientBucketType.SendEdit, options)
            .ConfigureAwait(false);
    }
