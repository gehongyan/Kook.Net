...
/// <summary>
///     提供用于修改 <see cref="Kook.ITextChannel"/> 的属性。
/// </summary>
/// <seealso cref="Kook.ITextChannel.ModifyAsync(System.Action{Kook.ModifyTextChannelProperties},Kook.RequestOptions)"/>
public class ModifyTextChannelProperties : ModifyGuildChannelProperties
{
    ...
    /// </summary>
    /// <remarks>
    ///     设置此值将要求每个用户在发送另一条消息之前等待指定的时间间隔；设置为 <see cref="Kook.SlowModeInterval.None"/>
