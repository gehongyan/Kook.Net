...
internal sealed class MockedTextChannel : ITextChannel
{
    ...
    public Task<Cacheable<IUserMessage, Guid>> SendFileAsync(Stream stream, string fileName, AttachmentType type = AttachmentType.File,
        IQuote quote = null,
        IUser ephemeralUser = null, RequestOptions? options = null) =>
        throw new NotImplementedException();
    ...
    public Task<Cacheable<IUserMessage, Guid>> SendCardAsync(ICard card, IQuote quote = null, IUser ephemeralUser = null,
        RequestOptions? options = null) => throw new NotImplementedException();
