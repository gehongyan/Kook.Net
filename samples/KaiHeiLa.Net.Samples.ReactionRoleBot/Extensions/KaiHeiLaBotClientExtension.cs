...
public partial class KaiHeiLaBotClientExtension : IHostedService
{
        ...
        ILogger logger, IHttpClientFactory httpClientFactory)
    {
        ...
        // _kaiHeiLaSocketClient.Ready += SendReactionCard;
        _kaiHeiLaSocketClient.ReactionAdded += ProcessReactionRoleAdd;
        _kaiHeiLaSocketClient.ReactionRemoved += ProcessReactionRoleRemove;
    }
